...
#' @description Estimativas dos indicadores a nível de UF
#' -----------------------------------------------------
...
indicadores_uf <- indicadores_municipais |>
  mutate(
...
write_parquet(indicadores_uf, sink = paste0("./output/base de dados - desigualdade/cad_indicadores_uf.parquet"))
write_csv2(indicadores_uf, file = paste0("./output/base de dados - desigualdade/cad_indicadores_uf.csv"))
