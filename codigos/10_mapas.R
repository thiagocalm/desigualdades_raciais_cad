...
#' @description Mapas
#' @update-description Mapas para o ranking ajustado para a pop. negra jovem a partir da lista enviada pelo Danilo
#' -----------------------------------------------------
...
DIR_output <- file.path("./output/resultados/mapas")
...
top50_df <- read_parquet(file = file.path(
  DIR_top50,
...
shape_br <- geobr::read_country()
shape_uf <- geobr::read_state()
shape_munic <- geobr::read_municipality()
shape_munic_point <- geobr::read_municipal_seat()
...
df_top50_shape_point <- shape_munic_point %>%
  left_join(
    top50_df %>% filter(nivel_geografico_2 == "Municipio"),
    by = c("code_muni_6d" = "cd_municipio_6digitos"),
    keep = FALSE
  ) %>%
  filter(ranking %in% 1:50) %>%
...
ggsave(
  filename = "BRASIL_mapa_proporcao_populacao_negra_por_municipio.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "BRASIL_mapa_proporcao_populacao_rural_por_municipio.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
df_shape_munic |>
  ...
  geom_sf(data = df_top50_shape_point,
          ...
          alpha = .8,
          shape = 21) +
  guides(fill = guide_colourbar(title = "Top 50 municípios \n(ranking de homicídios \nde jovens negros)")) +
  labs(
...
ggsave(
  filename = "BRASIL_mapa_top50_municipio_pontos_sem_gradiente.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
# 3.2 - Top 50 municipios de desigualdade (com gradiente de cores nos pontos)
...
df_shape_munic |>
  ...
  geom_sf(data = df_top50_shape_point,
          ...
          size = 2,
          colour = "#f7f7f7") +
  scale_fill_discrete(limits = rev(levels(as.factor(df_top50_shape_point$ranking_factor)))) +
  scale_fill_brewer(palette = "Oranges") +
  guides(fill = guide_legend(title = "Top 50 municípios \n(ranking de homicídios de \njovens negros)")) +
  labs(
...
ggsave(
  filename = "BRASIL_mapa_top50_municipio_pontos_COM_gradiente.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
#'---------------------------------------------------------------------------------
# 4 - Top 50 municipios de homicídio de jovens negros com poligono de proporção de negros
...
ggsave(
  filename = "BRASIL_mapa_top50_municipio_pontos_COM_gradiente_poligonos_com_prop_pop_negra.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
#'---------------------------------------------------------------------------------
# 5 - Top 50 municipios de homicídio de jovens negros com poligono de proporção de população rural
...
ggsave(
  filename = "BRASIL_mapa_top50_municipio_pontos_COM_gradiente_poligonos_com_prop_pop_rural.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "BRASIL_mapa_homicidios_absoluto_2013_2017.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "BRASIL_mapa_intervencoes_legais_absoluto_2013_2017.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
df_shape_munic |>
  ...
  geom_sf(aes(fill = indicador_pop_negra),
          lwd = 0) +
  geom_sf(data = shape_uf %>% filter(code_region == 2),
          fill = "transparent",
          colour = "black", size = 0.5) +
  scale_fill_viridis_c(option = 2, direction = -1) +
  guides(fill = guide_colourbar(title = "Proporção (x100) da população negra no município")) +
...
ggsave(
  filename = "NORDESTE_mapa_proporcao_populacao_negra_por_municipio.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "NORDESTE_mapa_proporcao_populacao_rural_por_municipio.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
# 3.1 - Top 50 municipios de desigualdade (sem gradiente de cores nos pontos)
...
df_shape_munic |>
  ...
  geom_sf(data = shape_uf %>% filter(code_region == 2),
          fill = "transparent",
          colour = "black", size = 0.5) +
  geom_sf(data = df_top50_shape_point %>% filter(code_region == 2),
          fill = "#e6550d",
          alpha = .8,
          shape = 21) +
  guides(fill = guide_colourbar(title = "Top 50 municípios \n(ranking de homicídios de \njovens negros)")) +
...
ggsave(
  filename = "NORDESTE_mapa_top50_municipio_pontos_sem_gradiente.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "NORDESTE_mapa_top50_municipio_pontos_COM_gradiente.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "NORDESTE_mapa_top50_municipio_pontos_COM_gradiente_poligonos_com_prop_pop_negra.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "NORDESTE_mapa_top50_municipio_pontos_COM_gradiente_poligonos_com_prop_pop_rural.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "NORDESTE_mapa_homicidios_absoluto_2013_2017.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
...
ggsave(
  filename = "NORDESTE_mapa_intervencoes_legais_absoluto_2013_2017.jpeg",
  device = "jpeg",
  path = DIR_output,
  width = 13,
  height = 13,
